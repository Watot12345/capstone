...
<div class="flex-1 px-6 pt-[26px] pb-20 mb-10 flex flex-col min-h-0 overflow-hidden">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
        <div class="bg-white rounded-xl shadow-xs p-3 border border-slate-200 text-center">
            ...
            <p class="text-xl font-bold text-slate-900"><?php echo $totalImmunizations; ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-xs p-3 border border-slate-200 text-center">
            <p class="text-xs text-slate-500 font-medium">Completed</p>
            <p class="text-xl font-bold text-emerald-600"><?php echo $completedImmunizations; ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-xs p-3 border border-slate-200 text-center">
            <p class="text-xs text-slate-500 font-medium">Missed</p>
            <p class="text-xl font-bold text-rose-600"><?php echo $missedImmunizations; ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-xs p-3 border border-slate-200 text-center">
            <p class="text-xs text-slate-500 font-medium">Due Soon</p>
            <p class="text-xl font-bold text-amber-600"><?php echo count($dueAlerts); ?></p>
        </div>
    </div>
