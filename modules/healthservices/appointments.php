        ...
        <div class="relative">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-slate-500">Total Appointments</p>
                </div>
            </div>
            <div class="mt-3 flex items-center gap-2">
                <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold">📋 All appointments</span>
                <span class="text-[10px] text-slate-400"><?php echo $totalConfirmed; ?> confirmed</span>
            </div>
        </div>
    </div>
    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:shadow-lg transition group">
        ...
        <div class="relative">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-emerald-600"><?php echo $totalConfirmed; ?></p>
    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:shadow-lg transition group">
        ...
        <div class="relative">
            ...
            <div class="mt-3 flex items-center gap-2">
                ...
                <span class="text-[10px] text-slate-400">Needs confirmation</span>
            </div>
        </div>
    </div>
