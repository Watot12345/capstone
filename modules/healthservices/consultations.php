    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:shadow-lg transition group">
        ...
        <div class="relative">
            ...
            <div class="mt-3 flex items-center gap-2">
                <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-[10px] font-bold">🩺 All consultations</span>
    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:shadow-lg transition group">
        ...
        <div class="relative">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-amber-600"><?php echo $pendingCount; ?></p>
                    <p class="text-xs font-medium text-slate-500">Follow-up Needed</p>
                </div>
            </div>
            <div class="mt-3 flex items-center gap-2">
    ...
    <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-slate-200 p-5 hover:shadow-lg transition group">
        ...
        <div class="relative">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-sky-600"><?php echo $todayConsultations; ?></p>
